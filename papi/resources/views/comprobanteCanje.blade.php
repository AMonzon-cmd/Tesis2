...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">¡Canjeaste un nuevo producto!.</div>
                  ...
                  <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                        ...
                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-top: 0; font-size: 24px; font-weight: 700; color: #ff5850;">{{$canje->cliente->nombre}}</p>
                        <p class="sm-leading-32" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px; font-size: 24px; font-weight: 600; color: #263238;">
                          Realizaste el canje de un producto  🤩
                        </p>
                        <p class="sm-leading-32" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px; font-size: 20px; font-weight: 600; color: #263238;">
                          #0{{$canje->created_at->format('YmdGi') . ' -  "' . $producto->nombre . '"'}}  
                        </p>
                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">Los puntos ya han sido descontados. </p>
                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">Recuerda:</p>
                        <ul style="margin-bottom: 24px;">
                          <li>Debes pasar a retirar el producto en una sucursal con tu documento de identidad.</li>
                          <li>Si no retiras el producto en un plazo de 7 dias perderas derecho a realizar el reclamo del mismo.</li>
                        </ul>
                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0;">
                          Si no realizaste el canje o es un error no dudes en contactarnos a 
                          <a href="mailto:support@example.com" class="hover-underline" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #7367f0; text-decoration: none;">soporte@payday.com</a>
                        </p>
                        <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
  <tr>
...
<p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">
  Sigue pagando tus facturas para acumular puntos!  😋
</p>
<p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">Saludos, <br>El equipo de Payday</p>
                      </td>
                    </tr>
                    <tr>
