                    ...
                    <div class="col-12 order-md-0 order-1">
                        <div class="card-body text-center">
                            <div class="row text-center justify-content-center">
                                ...
                                <h3 class="col-12 text-center mb-2">¡Realizaste el cambio de contraseña!</h3>
                                <p class="col-12 text-muted text-center mb-0">
                                    Se actualizo tu contraseña.
                                </p>
                                <p class="col-12 text-muted text-center mt-0">
                                    Prueba ingresa al sistema para comenzar a realizar pagos.
                                </p>
                                <button type="submit" class="btn btn-primary col-12 col-md-4 mt-2 mb-1" @click="realizarPago()">← Iniciar Sesion</button>
                            </div>
                            <span class="text-muted col-12">Por cualquier inconveniente no dudes en escribirnos a <a href="mailto:soporte@payday.com">soporte@payday.com</a></span>
                        </div>
                    </div>
                </div>
            </div>
